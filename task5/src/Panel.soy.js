 ...
 * @suppress {checkTypes}
 */
Templates.Panel.__deltemplate_s13_b861d06c = function(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
...
if (goog.DEBUG) {
  Templates.Panel.__deltemplate_s13_b861d06c.soyTemplateName = 'Templates.Panel.__deltemplate_s13_b861d06c';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Panel'), '', 0, Templates.Panel.__deltemplate_s13_b861d06c);
 ...
 * @suppress {checkTypes}
 */
Templates.Panel.__deltemplate_s19_062408b1 = function(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
...
if (goog.DEBUG) {
  Templates.Panel.__deltemplate_s19_062408b1.soyTemplateName = 'Templates.Panel.__deltemplate_s19_062408b1';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Panel'), 'element', 0, Templates.Panel.__deltemplate_s19_062408b1);
 ...
 * @suppress {checkTypes}
 */
Templates.Panel.__deltemplate_s27_2d1322d1 = function(opt_data, opt_ignored, opt_ijData) {
  var output = '';
  var elementId__soy28 = opt_data.id + '-' + (opt_data.surfaceId != null ? opt_data.surfaceId : 'title');
  output += '<div id="' + soy.$$escapeHtmlAttribute(elementId__soy28) + '">' + soy.$$escapeHtml(opt_data.elementContent) + '</div>';
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(output);
};
if (goog.DEBUG) {
  Templates.Panel.__deltemplate_s27_2d1322d1.soyTemplateName = 'Templates.Panel.__deltemplate_s27_2d1322d1';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Panel.title'), 'element', 0, Templates.Panel.__deltemplate_s27_2d1322d1);
 ...
 * @suppress {checkTypes}
 */
Templates.Panel.__deltemplate_s34_a9fcd55b = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Panel.__deltemplate_s34_a9fcd55b.soyTemplateName = 'Templates.Panel.__deltemplate_s34_a9fcd55b';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Panel.title'), '', 0, Templates.Panel.__deltemplate_s34_a9fcd55b);
 ...
 * @suppress {checkTypes}
 */
Templates.Panel.__deltemplate_s39_3ccc5482 = function(opt_data, opt_ignored, opt_ijData) {
  var output = '';
...
if (goog.DEBUG) {
  Templates.Panel.__deltemplate_s39_3ccc5482.soyTemplateName = 'Templates.Panel.__deltemplate_s39_3ccc5482';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Panel.body'), 'element', 0, Templates.Panel.__deltemplate_s39_3ccc5482);
 ...
 * @suppress {checkTypes}
 */
Templates.Panel.__deltemplate_s46_bb7be5f8 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Panel.__deltemplate_s46_bb7be5f8.soyTemplateName = 'Templates.Panel.__deltemplate_s46_bb7be5f8';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Panel.body'), '', 0, Templates.Panel.__deltemplate_s46_bb7be5f8);
